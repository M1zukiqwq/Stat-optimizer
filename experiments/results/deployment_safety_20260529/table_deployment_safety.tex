\begin{table*}[t]
  \centering
  \small
  \caption{Deployment safety checks. Projection and residual-based Hybrid gating are evaluated without oracle/fresh information. P/I/O/S denote OASIS, ISOMER, OASIS-noProj, and stale choices in the residual gate.}
