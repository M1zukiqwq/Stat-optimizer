-- TPC-DS base schema for PostgreSQL
-- Source adapted from tpcds-kit: https://github.com/M1zukiqwq/tpcds-kit.git
-- Notes:
--   1. This file keeps the benchmark base tables only.
--   2. It intentionally does not add the RI constraints from tpcds_ri.sql,
--      which keeps bulk loading simpler for experiment reruns.
